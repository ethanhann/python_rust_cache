...
def get_binary_item_handler(key: str):
...
def get_binary_compressed_item_handler(key: str):
    return {"key": key, "value": get_binary_item_decompressed(key)}


@app.get("/size")
def get_size_handler():
